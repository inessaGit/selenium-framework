...
public class TestWaits extends BaseTest {
	...
	public void testExplicitFluentWait() throws Exception {
		...
		// open the web url
		driver.get("https://www.google.com");
		// create a WebDriver wait object, max wait time of 30 seconds before throwing an exception
	...
	public void testExplicitWebDriverWait() throws Exception {
		...
		// wait for the visibility of the element ; once the element is visible, perform actions
